		        ...
		        <div class="col s12 m12">
		          	<div class="card">
		          		<div class="card-image">
				            ...
				            <span class="card-title"><strong><h4><a href="<?php echo ROUTES_DIR.'inicio.php';?>"><i class="material-icons small white-text left" style="font-size: 40px">arrow_back</i></a>Mallas</h4></strong></span>
				        </div>
