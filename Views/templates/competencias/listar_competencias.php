							        ...
							        <div class="actions">						<a href="competencias.php?action=nueva" class="modal-trigger waves-effect btn-flat nopadding"><i class="    material-icons right">add_circle</i>Crear competencia</a>		        
							      	...
							      	<table id="datatable">
								        ...
								        foreach ($this->data['competencias'] as $key) {
											...
											<td class="center no-padding">
									            	<a class="btn-floating waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Asignar asignaturas" href="competencias.php?result=asignar&param=<?php echo $key->getIdComp(); ?>"><i class="mdi mdi-book green white-text right"></i></a>
												</td>
								            <td class="center no-padding">
